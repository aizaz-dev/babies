...
export default function Home() {
  return (
    <main className="container">
      ...
      <div className="sixth">
      <h2 className="t9">
      “You don’t make a photograph just with a camera. You bring to the act of photography all the pictures you have seen, the books you have read, the music you have heard, the people you have loved.”</h2>
      <h3 className="t10">
      - Ansel Adams</h3>
