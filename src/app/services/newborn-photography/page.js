...
{/* Contact us */}
            ...
            <div className='contact-p'>
              ...
              <input type="text" placeholder='' className='input'/>
              <div className="Session-date">Session Date Preference <span>(Optional)</span></div>
              <input type="date" id='month' name='year' placeholder='' className='input'/>
              <div className="Kinds-of-session">What Kinds of Session <span>(Optional)</span></div>
              <select className='Select'>
                  <option className='option' value="Title">--Select--</option>
                  <option className='option' value="New born">New born</option>
                  <option className='option' value="Maternity">Maternity</option>
                  <option className='option' value="Cake Smashe">Cake Smashe (1st Birthday Photos)</option>
                  <option className='option' value="Family Portrai">Family Portrait Photos</option>
                  <option className='option' value="Holidays Photos">Holidays Photos</option>
                  <option className='option' value="Others">Others</option>
              </select>
              <div className="message">Message <span>(Optional)</span></div>
              <input type="text" placeholder='' className='input-mess'/>
              <div className="button">
              <button className='btn'>Submit</button></div>
              <div className="response">This form is protected by reCAPTCHA and the Google Privacy Policy and Terms of Service apply.</div>
